  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!isSupabaseConfigured) {
        ...
        alert('Demo Mode: Supabase is not configured. In a real app, you would be logged in now. Please follow the SUPABASE_SETUP_GUIDE.md instructions to set up Supabase for full functionality.');
        history.push('/');
        return;
      }
